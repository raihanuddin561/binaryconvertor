...
public class Convertor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(inputTxtArea);

        jButton2.setText("Convert to String");
        ...
        jLabel1.setText("Conver your text from here");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String bin = Arrays.toString(binary).replace(",","").replace("[", "").replace("]", "");
        
        outputTxtArea.setText(bin);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String input = inputTxtArea.getText();
        String output = StringProcess.getInstance(input).binaryToString();
